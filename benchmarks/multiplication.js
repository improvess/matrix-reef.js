...
if(!isNaN(aRows)) {
    ...
    console.log("number of A rows not provided or recognized as an integer. Using a random generated one: " + aRows);
}
...
if(!isNaN(aCols)) {
    ...
    console.log("number of A cols not provided or recognized as an integer. Using a random generated one: " + aCols);
}
...
if(!isNaN(bCols)) {
    ...
    console.log("number of B cols not provided or recognized as an integer. Using a random generated one: " + bCols);
}
